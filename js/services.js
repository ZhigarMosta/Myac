async function fetchData() {
  try {
    const response = await fetch("https://raw.githubusercontent.com/ZhigarMosta/Myac/main/json/services.json");
...
async function getDataServices() {
  ...
  renderListServices(servicesList);
}

const renderListServices = (Data) => {
